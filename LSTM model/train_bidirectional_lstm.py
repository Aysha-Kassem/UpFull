...
# ---------------------------
def build_bilstm_model(time_steps, n_features):
    model = Sequential([
...
def train_and_evaluate(epochs=80):
    ...
    checkpoint = ModelCheckpoint(
        "best_bilstm_fall_detection_model.keras",
        monitor='val_loss',
        save_best_only=True,
        verbose=1
    )
    ...
    # Save final model
    model.save("bilstm_fall_detection_model.keras")
    print("\n✅ Final BiLSTM model saved")
